    ...
    <div v-if="req" class="dcd-overlay">
      <div class="dcd-card">
        ...
        <div class="dcd-actions">
          ...
          <button class="dcd-btn dcd-btn--reject" @click="reject"><X :size="14" /> 拒绝</button>
          <button class="dcd-btn dcd-btn--apply" @click="apply"><Check :size="14" /> 应用</button>
        </div>
      </div>
    </div>
  </Teleport>
